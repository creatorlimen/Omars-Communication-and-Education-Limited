            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-lg p-8 sm:p-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-primary to-primary/80 text-white shadow-lg shadow-primary/20 rounded-full font-bold transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
        ...
        <section className="relative bg-gradient-to-br from-primary via-primary to-primary/80 text-white py-20 sm:py-28 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="#" onClick={() => document.getElementById('message')?.scrollIntoView({ behavior: 'smooth' })}>
              <Button size="lg" className="bg-white text-primary shadow-lg shadow-black/20 rounded-full font-bold transition-all duration-300 hover:scale-105">
                Get in Touch
              </Button>
            </a>
          </div>
